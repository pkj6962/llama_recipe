...
class train_config:
    ...
    dist_checkpoint_root_folder: str="/scratch/s5104a20/llama-recipes/chkpt" # wll be used if using FSDP
    #dist_checkpoint_root_folder: str="/dev/shm/chkpt" # wiwll be used if using FSDP
