...
from llama_recipes.model_checkpointing import load_model_sharded
...
def main(**kwargs):
    ...
    if train_config.enable_fsdp:
        ...
        if train_config.load_chkpt:
            load_model_sharded(model, rank, train_config);
        recovery_end_time = time.perf_counter() - recovery_start_time
        print("recovery time: ", recovery_end_time)  
